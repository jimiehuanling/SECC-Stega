...
def main():
    ...
    #================信息嵌入阶段================
    # 根据LT编码结果生成文本
    new_text = ls.sample(model, inital_text) 
    print('='*100) 
    ...
    print('='*100)
    print('the text after swapped_attack:', a3)
    #============================================
    ...
    modified_bitstream1 = '/data/guoyuzhe/rnn-test/LTextract/vlc-changed.txt' 
    index_matrix_name1 = '/data/guoyuzhe/rnn-test/LTextract/vlc-changed-index.txt'
    checked_str1 = ''
    ...
    modified_bitstream2 = '/data/guoyuzhe/rnn-test/LTextract/vlc-deleted.txt' 
    index_matrix_name2 = '/data/guoyuzhe/rnn-test/LTextract/vlc-deleted-index.txt'
    checked_str2 = ''
    ...
    modified_bitstream3 = '/data/guoyuzhe/rnn-test/LTextract/vlc-swapped.txt' 
    index_matrix_name3 = '/data/guoyuzhe/rnn-test/LTextract/vlc-swapped-index.txt'
    checked_str3 = ''
