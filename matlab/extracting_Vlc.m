...
resti = load('vlc-changed-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
...
resti = load('vlc-deleted-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
...
resti = load('vlc-swapped-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
