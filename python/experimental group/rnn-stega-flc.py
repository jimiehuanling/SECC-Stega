...
def main():
    ...
    #================信息嵌入阶段================
    # 根据LT编码结果生成文本
    new_text = ls.sample(model, length=60, top_k=32, sentence=inital_text) 
    print('='*100) 
    ...
    # 提取秘密信息矩阵
    length1 = len(a1)
    extract_matrix1 = ls.extract_from_text(model, length1, a1, top_k=32, sentence=inital_text)
    # 进行偶校验
    ...
    modified_bitstream1 = '/data/guoyuzhe/rnn-test/LTextract/flc-changed.txt' 
    index_matrix_name1 = '/data/guoyuzhe/rnn-test/LTextract/flc-changed-index.txt'
    checked_str1 = ''
    ...
    # 提取秘密信息矩阵
    length2 = len(a2)
    extract_matrix2 = ls.extract_from_text(model, length2, a2, top_k=32, sentence=inital_text)
    # 进行偶校验
    ...
    modified_bitstream2 = '/data/guoyuzhe/rnn-test/LTextract/flc-deleted.txt' 
    index_matrix_name2 = '/data/guoyuzhe/rnn-test/LTextract/flc-deleted-index.txt'
    checked_str2 = ''
    ...
    # 提取秘密信息矩阵
    length3 = len(a3)
    extract_matrix3 = ls.extract_from_text(model, length3, a3, top_k=32, sentence=inital_text)
    # 进行偶校验
    ...
    modified_bitstream3 = '/data/guoyuzhe/rnn-test/LTextract/flc-swapped.txt' 
    index_matrix_name3 = '/data/guoyuzhe/rnn-test/LTextract/flc-swapped-index.txt'
    checked_str3 = ''
