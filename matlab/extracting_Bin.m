...
resti = load('bin-changed-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
...
resti = load('bin-deleted-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
...
resti = load('bin-swapped-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
