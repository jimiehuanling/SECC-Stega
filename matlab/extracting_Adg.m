...
resti = load('adg-changed-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
...
resti = load('adg-deleted-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
...
resti = load('adg-swapped-index.txt');
resti = resti' + 1 ;
% 按行遍历矩阵
for i = 1:size(B11, 1)
    % 访问第i行
